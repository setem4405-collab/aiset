...
This Draft is intended for review before operational adoption.
...
It has not yet been approved as an operative subordinate specification.

The next intended actions are:

1. review this specification;
2. verify alignment with `PROGRAM-0001 v1.0 Review`;
3. correct any blocking or major findings;
4. approve or register the specification if appropriate;
5. use it for future operational records.
...
Closure of `NEW-003` requires a later review or disposition record confirming that:
