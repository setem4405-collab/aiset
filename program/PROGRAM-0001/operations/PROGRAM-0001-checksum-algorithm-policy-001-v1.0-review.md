...
Where this Review version conflicts with an approved higher-level PROGRAM-0001 requirement, the higher-level requirement prevails.
...
It has been approved by `PROGRAM-0001-REVIEW-009` for subordinate Review status. It has not yet been registered or acknowledged by the Publisher as the active subordinate Review policy.
...
4. apply it to Candidate Publication integrity records;
5. conduct later revision when cryptographic or operational requirements change.
