...
**Review Record:** PROGRAM-0001-REVIEW-001

**Previous Version:** PROGRAM-0001 v0.2 Draft
...
This document is the formal Review version of the AISET Program Charter.

It entered Review status following completion of:

`PROGRAM-0001-REVIEW-001 — Internal Architectural and Governance Review`

The review assessed `PROGRAM-0001 v0.2 Draft` as architecturally coherent and suitable to enter formal Review status.

This document has not yet been approved as the governing Charter of the AISET Program or as an AISET Reference Publication.
...
- preparation of a Candidate Publication.

The following provisions are intended to become normative for the AISET Program upon final approval:
...
Where this Charter uses **MUST**, **MUST NOT**, **SHOULD**, **SHOULD NOT**, or **MAY**, those terms express intended normative program requirements.

While this document remains in Review status, its provisions are reviewable and non-binding.

Changes resulting from Review must be traceable to review findings, editorial records, decision records, or other documented program actions.
...
This document is the formal Review version of the first proposed AISET Program Charter.

The transition from `PROGRAM-0001 v0.2 Draft` to `PROGRAM-0001 v0.3 Review` is supported by:

`PROGRAM-0001-REVIEW-001 — Internal Architectural and Governance Review`

The review identified no blocking architectural or governance defect and recommended progression to Review status.

During Review, the document may receive:
...
- documented objections and proposed amendments.

This Review version is not yet an approved publication, governing Charter, or AISET Reference Publication.

The next intended lifecycle state is Candidate Publication, subject to completion of applicable review and resolution of blocking findings.
