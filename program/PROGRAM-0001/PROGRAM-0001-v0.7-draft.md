...
**Previous Version:** PROGRAM-0001 v0.6 Review
...
This document is a targeted Draft revision of the AISET Program Charter.

It was prepared in response to:

`PROGRAM-0001-REVIEW-005 — Editorial and Governance Readiness Review`

That review assessed `PROGRAM-0001 v0.6 Review` as structurally coherent but not yet governance-ready for Candidate Publication.

The review identified:

- two blocking governance findings;
- three major governance findings;
- five moderate governance and editorial findings;
- one editorial improvement finding.

This Draft returns the Charter from Review to Draft for the purpose of:

- establishing minimum separation-of-authority rules;
- restricting self-approval of normative changes;
- defining Candidate Publication readiness criteria;
- formalizing reconsideration, appeal, and dispute handling;
- defining conflict-of-interest disclosure and recusal;
- establishing contributor proposal and disposition rights;
- defining registry status semantics;
- defining emergency governance procedures;
- clarifying lifecycle and publication terminology;
- improving normative and informative boundaries;
- classifying referenced governance artifacts;
- consolidating repeated governance requirements.

The verified normative terminology corrections accepted through `PROGRAM-0001-REVIEW-004` remain preserved.

The Technology Independence clause remains unchanged.
...
While this document remains in Draft status, its provisions remain reviewable and non-binding.
---
...
The canonical lifecycle states are Draft, Review, Candidate Publication, Approved Publication, and Withdrawn.
...
This document is a targeted governance and editorial Draft revision of the proposed AISET Program Charter.

The transition to `PROGRAM-0001 v0.7 Draft` follows this recorded sequence:

1. `PROGRAM-0001 v0.3 Review`;
2. `PROGRAM-0001-REVIEW-002 — Normative Terminology Review`;
3. `PROGRAM-0001 v0.4 Draft`;
4. `PROGRAM-0001-REVIEW-003 — Normative Terminology Re-review`;
5. `PROGRAM-0001 v0.5 Draft`;
6. `PROGRAM-0001-REVIEW-004 — Targeted Normative Verification Review`;
7. `PROGRAM-0001 v0.6 Review`;
8. `PROGRAM-0001-REGISTRY-002`;
9. `PROGRAM-0001-PUBLISHER-ACK-002`;
10. `PROGRAM-0001-REVIEW-005 — Editorial and Governance Readiness Review`;
11. `PROGRAM-0001 v0.7 Draft`.

`PROGRAM-0001-REVIEW-005` identified two blocking governance findings: concentration of authority and incomplete Candidate Publication entry criteria.

It also identified findings involving decision reconsideration and appeal, conflict-of-interest treatment, contributor participation rights, registry status semantics, emergency governance, lifecycle terminology, normative and informative boundaries, cross-reference precision, and repetition or consolidation.

This Draft addresses those findings by introducing explicit Approval Authority, self-approval restrictions, minimum independent confirmation for Candidate Publication, operational delegation and revocation rules, material proposal identifiers and dispositions, contributor attribution and resubmission rights, participation restriction records, review classification, conflict-of-interest treatment and recusal, complete reconsideration and appeal records, Candidate Publication readiness evidence, Candidate Publication blocking conditions, emergency governance actions and retrospective review, canonical lifecycle terminology, registry status definitions and transition rules, and registry conflict, correction, and integrity procedures.
...
This Draft is not yet a Candidate Publication, Approved Publication, governing Charter of the AISET Program, or AISET Reference Publication.

The next intended action is a governance and editorial re-review of the dispositions recorded against `PROGRAM-0001-REVIEW-005`.

Progression beyond Draft requires applicable review, registry, decision, and Publisher records.
---
