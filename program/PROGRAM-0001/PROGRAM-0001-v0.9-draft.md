...
**Previous Version:** PROGRAM-0001 v0.8 Review
...
This document is a targeted Draft revision of the AISET Program Charter following:

`PROGRAM-0001-REVIEW-007 — Security and Privacy Review`

The revision addresses the blocking findings:

- `SEC-001 — Governance Record Classification and Access Control`;
- `SEC-002 — Candidate Publication Artifact Integrity`.

It also addresses or materially advances the major and moderate security and privacy findings concerning personal data, restricted records, retention, incident response, credential compromise, continuity, governance capture, security reporting, third-party dependencies, and security-sensitive changes.

The revision also advances the remaining non-blocking findings from `PROGRAM-0001-REVIEW-006`, including normative and informative boundaries, cross-reference precision, foundation-stage exception authority, and lifecycle-list alignment.

This Draft preserves the verified Technology Independence clause, normative keyword policy, authority separation, self-approval restrictions, Candidate Publication readiness requirements, registry integrity rules, emergency governance, contributor safeguards, and appeal safeguards.
...
The purpose of this Draft is to enable targeted security, privacy, governance, and editorial re-review.
...
The transition to `PROGRAM-0001 v0.9 Draft` follows:
...
- personal-data and restricted-record rules;
...
This Draft is intended to resolve `SEC-001` and `SEC-002` and materially address the remaining findings from `PROGRAM-0001-REVIEW-007`.
...
1. targeted security, privacy, governance, and editorial re-review;
2. verification of `SEC-001` and `SEC-002`;
3. disposition of remaining findings;
4. return to Review if permitted;
5. registry and Publisher records for any later lifecycle transition;
6. independent or second-party review before Candidate Publication.

Any transition beyond Draft requires applicable review, registry, decision, and Publisher records.
---
